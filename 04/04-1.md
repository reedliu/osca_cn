...
另外新版本的包还加入了其他很多数据集，在官网帮助文档可以看到全部：[https://bioconductor.org/packages/release/data/experiment/vignettes/scRNAseq/inst/doc/scRNAseq.html\#available-data-sets，而且随时欢迎新数据集的加入](https://bioconductor.org/packages/release/data/experiment/vignettes/scRNAseq/inst/doc/scRNAseq.html#available-data-sets，而且随时欢迎新数据集的加入)
